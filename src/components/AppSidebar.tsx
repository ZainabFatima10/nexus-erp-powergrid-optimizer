...
import { LayoutDashboard, Package, BarChart3, Cloud, MessageSquare, Bell, LogOut, ChevronLeft, ChevronRight, ClipboardList } from "lucide-react";
...
const navItems = [
  ...
  { title: "Procurement", url: "/procurement", icon: ClipboardList },
